...
const honeyDripWordmark = 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-BcdHRl36UiFKPnhisdpUPUCKW2p6Vd.png';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg-base)] p-4">
      <div className="w-full max-w-md bg-[var(--surface-1)] rounded-[var(--radius)] border border-[var(--border-hairline)] p-8 shadow-xl">
        {/* Logo and Title */}
        <div className="flex justify-center mb-6">
          <img src={honeyDripLogo || "/placeholder.svg"} alt="Honey Drip Network" className="w-32 h-32 rounded-lg" />
        </div>
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--text-muted)] text-sm italic mb-2">
            by FancyTrader
          </p>
