...
export function NowPanelManage({
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden animate-mode-enter">
      ...
      {/* Dynamic Profit Targets - T1/T2/T3 with R:R */}
      {trade.contract && (
        <div className="px-4 py-2 border-b border-[var(--border-hairline)]">
...
function QuickActionsSection({
  ...
  const [showThesisMonitor, setShowThesisMonitor] = useState(false);
  ...
  return (
    <div className="flex-shrink-0 border-t border-[var(--border-hairline)] bg-[var(--surface-1)]">
      ...
      <div className="p-3 border-b border-[var(--border-hairline)]">
        ...
        {/* Primary Action Buttons: [Trim 50%] [Trail Stop] [CLOSE ALL] */}
        <div className="grid grid-cols-3 gap-2">
          ...
          <button
            ...
            className={cn(
              "flex items-center justify-center gap-1.5 py-2.5 rounded-lg font-semibold text-sm transition-all btn-press border",
              isExpired || !onTrim
                ? disabledClass
                : "bg-[var(--surface-2)] border-[var(--brand-primary)]/30 hover:bg-[var(--surface-3)] hover:border-[var(--brand-primary)]"
            )}
          ...
          >
            ...
            />
            <span className="text-[var(--text-high)]">Trim 50%</span>
          </button>
          ...
          <button
            ...
            className={cn(
              ...
              isExpired || !onTrailStop
                ? disabledClass
                : "bg-[var(--surface-2)] border-[var(--accent-positive)]/30 hover:bg-[var(--surface-3)] hover:border-[var(--accent-positive)]"
            )}
          ...
          >
            ...
            />
            <span className="text-[var(--text-high)]">Trail Stop</span>
          </button>

          {/* CLOSE ALL / MANUAL EXIT */}
          <button
            onClick={() => onExit?.(sendAlertOnExit)}
            disabled={!onExit}
            className={cn(
              "flex items-center justify-center gap-1.5 py-2.5 rounded-lg font-bold text-sm transition-all btn-press",
              !onExit
                ? disabledClass
                : isExpired
            ...
            title={isExpired ? "Manually close expired position" : "Close entire position"}
          >
            {isExpired ? <AlertTriangle className="w-4 h-4" /> : <DollarSign className="w-4 h-4" />}
            {isExpired ? "MANUAL EXIT" : "CLOSE ALL"}
          </button>
        </div>
        ...
        <div className="grid grid-cols-4 gap-2 mt-2">
          ...
          <button
            ...
            disabled={isExpired || !onTrim}
            className={cn(
              "flex flex-col items-center justify-center p-1.5 rounded border transition-all btn-press",
          ...
          >
            ...
            />
            <span className="text-[9px] font-medium text-[var(--text-muted)]">25%</span>
          </button>
          ...
          >
            ...
            />
            <span className="text-[9px] font-medium text-[var(--text-muted)]">SL→BE</span>
          </button>
          ...
          <button
            ...
            title="Take profit at target"
          >
            <Target
              className={cn(
                "w-3 h-3 mb-0.5",
                onTakeProfit ? "text-[var(--accent-positive)]" : "text-[var(--text-muted)]/50"
              )}
            />
            <span className="text-[9px] font-medium text-[var(--text-muted)]">TP</span>
          </button>
          ...
          <button
            ...
            title="Broadcast update to Discord"
          >
            <Bell
              className={cn(
                "w-3 h-3 mb-0.5",
                showBroadcast ? "text-[var(--brand-primary)]" : "text-[var(--text-muted)]"
              )}
            />
            <span className="text-[9px] font-medium text-[var(--text-muted)]">Alert</span>
          </button>
        </div>
        ...
        <label className="flex items-center gap-2 mt-3 cursor-pointer">
          <input
            ...
            className="w-3.5 h-3.5 rounded border-[var(--border-hairline)] bg-[var(--surface-2)] text-[var(--brand-primary)] focus:ring-[var(--brand-primary)] focus:ring-offset-0"
          />
      ...
      {/* ========== THESIS MONITOR (Flow Pulse) ========== */}
      <div className="border-b border-[var(--border-hairline)]">
        <button
          onClick={() => setShowThesisMonitor(!showThesisMonitor)}
        ...
        >
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[10px] text-[var(--text-faint)] ml-1">Flow Pulse</span>
          </div>
          {showThesisMonitor ? (
      ...
      {showBroadcast && onBroadcastUpdate && (
        <div className="p-3 border-b border-[var(--border-hairline)] bg-[var(--surface-0)]">
          <div className="space-y-2">
            <textarea
